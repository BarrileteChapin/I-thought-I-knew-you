class Component extends DCLogic {
  ...
  state = {
    ...
    writeIn: false, writeText: '', writeStatus: null, chatGroupDraft: '', chatDmDraft: '', chatBusy: false, chatBusyTab: null, llmStatus: '', actionsOpen: false, chatGroupLeft: 5, chatDmLeft: 5, llmUsedReplies: [], llmReplySeed: 0,
    dragItem: null, pickIdx: null, pickerOpen: false, pickerMode: 'search', searched: {}, aiChecked: {}, aiPickIdx: null, aiStage: 'idle', aiStep: 0, actionLog: [], reactionTimes: [],
